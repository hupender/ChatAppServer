...
NO_TOKEN = _("Token is not provided.")
INVALID_TOKEN = _("Token has expired or is invalid.")
USER_NOT_FOUND = _("User not exists in the system.")
USER_BLOCKED = _("User has been blocked.")
INVALID_OLD_PASSWORD = _("Password is incorrect.")
EMAIL_MOBILE_NOT_EXIST = _("Email and mobile does not exist for this account.")
CAN_NOT_UPDATE_OTHER_USER = _("User don't have the permission to operate on this resource.")
